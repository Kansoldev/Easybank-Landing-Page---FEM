const Footer = () => {
  return (
    <footer className="bg-[#2d314e] text-center">
      <div className="container py-10 px-4 mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="logo grow">
            ...
            <div className="socials flex items-center gap-4 mt-12">
              <a href="#">
          ...
          <div className="lg:flex grow justify-around items-center text-center lg:text-left text-white mt-8 mb-10">
            <ul>
              <li>
                <a href="#" className="hover:text-[#31d35c]">
                  About Us
                </a>
              </li>
